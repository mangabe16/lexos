...
@pytest.mark.parametrize("window,pattern,expected", [
...
@pytest.mark.parametrize("mode,window,pattern,expected", [
...
@pytest.mark.parametrize("window,pattern,mode,expected", [
...
@pytest.mark.parametrize("window_type,pattern,mode", [
...
@pytest.mark.parametrize("window_type,window,pattern,expected", [
