...
class TestCorpusCommunicationArchitecture:
    ...
    def test_import_analysis_results_basic(self, populated_corpus):
        ...
        # Test basic import
        populated_corpus.import_analysis_results('kmeans', test_results, version='1.0.0')
    ...
    def test_import_analysis_results_overwrite_protection(self, populated_corpus):
        ...
        with pytest.raises(ValueError, match="Results for module 'test_module' already exist"):
            populated_corpus.import_analysis_results('test_module', {'new': 'data'})
        
        # Import with overwrite=True should work
        populated_corpus.import_analysis_results('test_module', {'new': 'data'}, overwrite=True)
        assert populated_corpus.analysis_results['test_module']['results'] == {'new': 'data'}
    ...
    def test_validate_analysis_compatibility_compatible(self, populated_corpus):
        ...
        compatibility = populated_corpus.validate_analysis_compatibility('compatible_module')
        ...
        assert compatibility['current_fingerprint'] == compatibility['stored_fingerprint']
    ...
    def test_validate_analysis_compatibility_incompatible(self, populated_corpus):
        ...
        compatibility = populated_corpus.validate_analysis_compatibility('incompatible_module')
    ...
    def test_validate_analysis_compatibility_no_results(self, populated_corpus):
        ...
        compatibility = populated_corpus.validate_analysis_compatibility('nonexistent_module')
    ...
    def test_analysis_results_versioning(self, populated_corpus):
        ...
        # Test custom version
        populated_corpus.import_analysis_results('version_module2', test_results, version='2.1.0')
        assert populated_corpus.analysis_results['version_module2']['version'] == '2.1.0'
