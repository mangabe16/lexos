...
<img src="../../../tutorials/cluster/elbow.png" alt="Sample elbow plot">
...
<img src="../../../tutorials/cluster/2D_scatter.png" alt="Sample KMeans Clustering 2D Plot">
...
<img src="../../../tutorials/cluster/3D_scatter.png" alt="Sample KMeans Clustering 3D Plot">
...
<img src="../../../tutorials/cluster/voronoi.png" alt="Sample KMeans Clustering Voronoi diagram">
...
Under the hood, `save()` calls Plotly's <code><a href="https://plotly.github.io/plotly.py-docs/generated/plotly.io.image_html.html">write_image()</a></code> and <code><a href="https://plotly.github.io/plotly.py-docs/generated/plotly.io.write_html.html">write_html()</a></code>, and it will accept any keywords taken by those methods.

You can also call `to_csv()` to export your data to a CSV file of PCA coordinates and cluster labels. `Kmeans.to_csv()` accepts any parameter taken by the Pandas<code><a href="https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.to_csv.html">to_csv()</a></code> method.
