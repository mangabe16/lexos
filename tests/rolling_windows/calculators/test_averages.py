...
@pytest.mark.parametrize("pattern,window_text,window_size,expected", [
...
def test_averages_various_patterns(basic_averages, pattern, window_text, window_size, expected):
...
@pytest.mark.parametrize("patterns,expected_columns", [
    (["a", "b"], ["a", "b"]),
