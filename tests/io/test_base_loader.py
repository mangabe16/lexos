...
@pytest.fixture
def base_loader_with_data(sample_paths, sample_mime_types, sample_names, sample_texts, sample_errors):
...
def test_base_loader_data(base_loader_with_data, sample_paths, sample_mime_types, sample_names, sample_texts, sample_errors):
...
def test_base_loader_records(base_loader_with_data, sample_paths, sample_mime_types, sample_names, sample_texts):
...
def test_base_loader_iter(base_loader_with_data, sample_paths, sample_mime_types, sample_names, sample_texts):
    """Test BaseLoader records property."""
...
def test_base_loader_df(base_loader_with_data, sample_paths, sample_mime_types, sample_names, sample_texts):
...
def test_base_loader_reset(base_loader_with_data):
    ...
    base_loader_with_data.errors == [1]
