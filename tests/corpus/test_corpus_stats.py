...
class TestCorpusStatsDistributionStats:
    ...
    def test_distribution_stats_cached_property(self, sample_docs):
        ...
        expected_keys = {
            ...
            "shapiro_statistic", "shapiro_p_value", "is_normal"
        }
    ...
    def test_percentiles_cached_property(self, sample_docs):
        ...
        expected_keys = {
            ...
            "percentile_75", "percentile_90", "percentile_95", "min", "max", "range"
        }
...
class TestCorpusStatsTextDiversityStats:
    ...
    def test_text_diversity_stats_cached_property(self, sample_docs):
        ...
        # Verify expected keys
        expected_keys = {
            "mean_ttr", "median_ttr", "std_ttr", "corpus_ttr",
            "mean_hapax_ratio", "median_hapax_ratio", "std_hapax_ratio",
            "total_hapax", "corpus_hapax_ratio", "mean_dislegomena_ratio",
            "median_dislegomena_ratio", "total_dislegomena", "corpus_dislegomena_ratio"
        }
...
class TestCorpusStatsAdvancedLexicalDiversity:
    ...
    def test_advanced_lexical_diversity_cached_property(self, sample_docs):
        ...
        # Verify expected keys
        expected_keys = {
            "mean_cttr", "median_cttr", "std_cttr",
            "mean_rttr", "median_rttr", "std_rttr",
            "mean_log_ttr", "median_log_ttr", "std_log_ttr",
            "diversity_range", "diversity_coefficient_variation"
        }
    ...
    def test_mattr_calculation_edge_cases_lines_460_468(self):
        ...
        short_docs = [
            ("doc1", "Short Doc", ["word1", "word2", "word3"])  # Only 3 tokens, less than default window_size of 50
        ]
        ...
        long_tokens = ["word" + str(i % 20) for i in range(100)]  # 100 tokens with some repetition
    ...
    def test_advanced_lexical_diversity_calculations(self):
        ...
        test_docs = [
            ...
            ("doc2", "Document 2", list(range(20))),  # High diversity (converted to strings)
        ]
        # Convert numbers to strings for realistic token data
        test_docs[1] = (test_docs[1][0], test_docs[1][1], [str(i) for i in test_docs[1][2]])
...
class TestCorpusStatsZipfAnalysis:
    ...
    def test_zipf_analysis_cached_property(self, sample_docs):
        ...
        # Verify expected keys
        expected_keys = {
            "zipf_slope", "zipf_intercept", "r_squared", "zipf_goodness_of_fit",
            "follows_zipf", "num_terms"
        }
    ...
    def test_zipf_analysis_coverage_lines_528_529_558_565_587_588(self):
        ...
        print("✓ Zipf analysis specific lines covered (528-529, 558-559, 561-562, 564-565, 587-588)")
...
class TestCorpusStatsQualityMetrics:
    ...
    def test_corpus_quality_metrics_cached_property(self, sample_docs):
        ...
        expected_keys = {
            "document_length_balance", "vocabulary_density_balance",
            "corpus_coverage", "vocabulary_richness", "corpus_size_metrics"
        }
        ...
        assert length_balance["classification"] in ["very_balanced", "balanced", "moderately_unbalanced", "highly_unbalanced"]
        ...
        assert richness["sampling_adequacy"] in ["excellent", "good", "adequate", "insufficient"]
    ...
    def test_corpus_quality_metrics_classifications(self):
        ...
        assert quality_metrics["document_length_balance"]["classification"] in ["very_balanced", "balanced"]
        ...
        assert quality_metrics_unbalanced["document_length_balance"]["classification"] in ["moderately_unbalanced", "highly_unbalanced"]
    ...
    def test_quality_metrics_edge_cases_lines_631_633_644_646(self):
        ...
        assert balance_class in ["very_balanced", "balanced", "moderately_unbalanced", "highly_unbalanced"]
        ...
        unbalance_cv = unbalanced_quality["document_length_balance"]["coefficient_variation"]
        balanced_cv = balanced_quality["document_length_balance"]["coefficient_variation"]
        ...
        assert vocab_richness["sampling_adequacy"] in ["excellent", "good", "adequate", "insufficient"]
...
class TestCorpusStatsGroupComparison:
    ...
    def test_compare_groups_mann_whitney(self, group_comparison_docs):
        ...
        result = stats.compare_groups(group1_labels, group2_labels, test_type="mann_whitney")
        
        # Verify expected keys
        expected_keys = {
            "group1_size", "group2_size", "group1_mean", "group2_mean",
            "metric", "test_type", "statistic", "p_value", "effect_size",
            "effect_size_interpretation", "is_significant", "significance_level"
        }
    ...
    def test_compare_groups_different_metrics(self, group_comparison_docs):
        ...
        for metric in ["total_tokens", "total_terms", "vocabulary_density", "hapax_legomena"]:
...
class TestCorpusStatsBootstrapCI:
    ...
    def test_bootstrap_confidence_interval_default(self, sample_docs):
        ...
        # Verify expected keys
        expected_keys = {
            "metric", "confidence_level", "n_bootstrap", "original_mean",
            "bootstrap_mean", "bootstrap_std", "ci_lower", "ci_upper", "margin_of_error"
        }
        assert set(result.keys()) == expected_keys
    ...
    def test_bootstrap_confidence_interval_different_metrics(self, sample_docs):
        ...
        # Test with different metrics
        metrics = ["total_tokens", "total_terms", "vocabulary_density", "hapax_legomena"]
        
        for metric in metrics:
            result = stats.bootstrap_confidence_interval(metric=metric, n_bootstrap=100)  # Smaller n for speed
            assert result["metric"] == metric
            assert isinstance(result["original_mean"], (int, float))
            assert isinstance(result["ci_lower"], (int, float))
            assert isinstance(result["ci_upper"], (int, float))
...
class TestCorpusStatsHelperMethods:
    ...
    def test_interpret_effect_size_boundaries(self, sample_docs):
        ...
        for effect_size, expected in test_cases:
            ...
            assert result == expected, f"Effect size {effect_size} should be {expected}, got {result}"
    ...
    def test_interpret_cohens_d_boundaries(self, sample_docs):
        ...
        for cohens_d, expected in test_cases:
            ...
            assert result == expected, f"Cohen's d {cohens_d} should be {expected}, got {result}"
...
class TestCorpusStatsErrorHandling:
    ...
    def test_empty_dataframe_error(self):
        ...
        with pytest.raises(Exception, match="vocabulary is empty|Error converting DTM to DataFrame"):
            stats = CorpusStats(docs=empty_docs)
    ...
    def test_doc_stats_df_empty_check_line_250(self):
        ...
        try:
            ...
            print("✓ Empty data handling works (CorpusStats prevents empty initialization)")
...
class TestCorpusStatsPlotting:
    ...
    def test_plot_method_column_parameter(self, sample_docs):
        ...
        valid_columns = ["total_tokens", "total_terms", "vocabulary_density", "hapax_legomena"]
    ...
    def test_plot_method_title_parameter(self, sample_docs):
        ...
        try:
            stats.plot(column="total_tokens", type="seaborn_boxplot", title="Custom Title")
        except Exception as e:
...
class TestCorpusStatsPlottingFunctions:
    ...
    def test_plotting_functions_with_different_columns(self, sample_docs):
        ...
        columns = ["total_tokens", "total_terms", "vocabulary_density", "hapax_legomena"]
