...
class TestBubbleChart:
    ...
    def test_bubblechart_with_spacy_doc(self, nlp):
    ...
    def test_bubblechart_with_spacy_span(self, nlp):
    ...
    def test_bubblechart_with_token_list(self, nlp):
    ...
    def test_bubblechart_with_doc_list(self, nlp):
    ...
    def test_bubblechart_nested_token_lists(self, nlp):
