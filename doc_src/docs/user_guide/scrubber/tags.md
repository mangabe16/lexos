...
scrubbed_text = remove_element(text, selector="p") # Remove <p>
scrubbed_text = replace_tag(scrubbed_text, selector="span", replacement="p") # Replace <span> with <p>

print(scrubbed_text)  # Output: "<p>Hello again!</p>"
```
...
print(scrubbed_text)  # Output: "<p id="2">Hello again!</p>"
```
...
print(scrubbed_text)  # Output: "<div>Text</div>"
```
...
print(scrubbed_text)  # Output: "<div class="keep">Text</div><div>Text</div>"
```
...
# Output: '<div data-type="main">Text</div>'
...
# Output: '<p class="highlight">Text</p><p class="data">More</p>'
...
# Output: '<div role="main" id="content">Text</div><div class="sidebar">Side</div>'
```
...
print(scrubbed_text)
# Output: "<span>Hello world</span><span class="change">Hello, world!</span>"
```
