...
def test_run_pipeline_returns_expected_structures_without_smote():
    ...
    train_data, train_labels, unknown_data, unknown_ids = (
        _build_tiny_authorship_dataset()
    )
    ...
    assert set(results.holdout_metrics.keys()) == {
        "accuracy",
        "balanced_accuracy",
        "macro_f1",
    }
    ...
    assert set(results.cv_fold_metrics.columns) == {
        "fold",
        "accuracy",
        "balanced_accuracy",
        "macro_f1",
    ...
    assert set(results.cv_mean_metrics.keys()) == {
        "accuracy",
        "balanced_accuracy",
        "macro_f1",
    }
